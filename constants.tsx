...
export const ELECTION_MOODS = [
  { id: 'queue', label: 'The Patient Queue', icon: 'groups', image: '/images/voter-queue.webp', prompt: "Masterpiece hyper-realistic sharp-focus photograph of Kenyan citizens of diverse ages queuing peacefully at a village polling station. Golden hour sunlight, dust particles in the air, authentic Kenyan clothing, deep emotional resonance, 8k resolution." },
  { id: 'ink', label: 'The Purple Finger', icon: 'done_all', image: '/images/seal-of-duty.webp', prompt: "Macro photography of an elderly Kenyan hand with visible wisdom lines, featuring a vivid purple indelible ink stain on the index finger. Soft bokeh background of a Kenyan landscape, high texture detail, cinematic lighting." },
  { id: 'papers', label: 'The 6-Ballots', icon: 'style', image: '/images/your-choice-your-voice.webp', prompt: "Professional studio flat-lay of six official Kenyan ballot papers with distinct vibrant colors (Green, Yellow, White, etc.). Each paper has crisp text and the IEBC logo, arranged symmetrically on a rustic wooden table, high-contrast, elegant." },
  { id: 'winner', label: 'Peaceful Victory', icon: 'celebration', image: '/images/peaceful-progress.webp', prompt: "A cinematic wide shot of a multi-ethnic group of Kenyans celebrating in a Nairobi city square. Waving the Kenyan flag, joyful expressions, high motion detail, vibrant colors, majestic sky, patriotic and unified atmosphere." }
];
...
export const LEARN_TOPICS: LearnTopic[] = [
  ...
  { 
    ...
    image: "/images/campaign-finance.webp",
  ...
  { 
    ...
    category: 'Oversight', 
    lastUpdated: 'June 2024',
    image: "/images/election-observers.webp",
  ...
  { 
    ...
    category: 'Legal', 
    lastUpdated: 'June 2024',
    image: "/images/dispute-resolution.webp",
  ...
  { 
    ...
    category: 'Rights', 
    lastUpdated: 'June 2024',
    image: "/images/secret-of-ballot.webp",
  ...
  { 
    ...
    lastUpdated: 'June 2024',
    image: "/images/seats-for-everyone.webp",
  ...
  { 
    ...
    category: 'Equality', 
    lastUpdated: 'June 2024',
    image: "/images/balanced-leadership.webp",
  ...
  { 
    ...
    lastUpdated: 'June 2024',
    image: "/images/holding-leaders-accountable.webp",
  ...
  { 
    ...
    category: 'Devolution', 
    lastUpdated: 'June 2024',
    image: "/images/Your Vote & Your Hospital-1.webp",
  ...
  { 
    ...
    category: 'Rights', 
    lastUpdated: 'Mar 2024',
    image: "/images/senior-rights.webp",
  ...
  { 
    ...
    image: "/images/peace-after-vote.webp",
  ...
  { 
    ...
    category: 'Dates', 
    lastUpdated: 'May 2024',
    image: "/images/key-election-dates.webp",
  ...
  { 
    ...
    category: 'Dates', 
    lastUpdated: 'Mar 2024',
    image: "/images/voter-registration.webp",
  ...
  { 
    ...
    category: 'Process', 
    lastUpdated: 'Mar 2024',
    image: "/images/how-to-register.webp",
  ...
  { 
    ...
    lastUpdated: 'Mar 2024',
    image: "/images/verify-status.webp",
  ...
  { 
    ...
    category: 'Safety', 
    lastUpdated: 'Mar 2024',
    image: "/images/election-offenses.webp",
...
export const IEBC_OFFICES: IEBCOffice[] = [
  ...
  // GARISSA COUNTY
  { county: "Garissa", constituency: "Garissa Township", location: "Off Lamu Road, Behind Ministry Of Water Garage", landmark: "N/A", distance: "N/A" },
  { county: "Garissa", constituency: "Balambala", location: "Balambala Town Next To Dc's Office", landmark: "N/A", distance: "N/A" },
  { county: "Garissa", constituency: "Lagdera", location: "Modogashe Town, Opposite Police Station", landmark: "N/A", distance: "N/A" },
  { county: "Garissa", constituency: "Dadaab", location: "Dadaab Town, Opposite Un Compound", landmark: "N/A", distance: "N/A" },
  { county: "Garissa", constituency: "Fafi", location: "Next To Dc's Office", landmark: "N/A", distance: "N/A" },
  { county: "Garissa", constituency: "Ijara", location: "Masalani Town, Next To Dc's Office.", landmark: "N/A", distance: "N/A" },
  // WAJIR COUNTY
  ...
  // MACHAKOS COUNTY
  { county: "Machakos", constituency: "Masinga", location: "Masinga Town Opposite MULKAS petrol station", landmark: "N/A", distance: "N/A" },
  { county: "Machakos", constituency: "Yatta", location: "NCPB Compound - Kithimani, Yatta", landmark: "N/A", distance: "N/A" },
  { county: "Machakos", constituency: "Kangundo", location: "Ministry Of Works Bulding", landmark: "Kangundo General Hospital", distance: "N/A" },
  { county: "Machakos", constituency: "Matungulu", location: "Kangundo Junior School Within Tala Town", landmark: "N/A", distance: "N/A" },
  { county: "Machakos", constituency: "Kathiani", location: "DCCs Office block", landmark: "N/A", distance: "N/A" },
  { county: "Machakos", constituency: "Mavoko", location: "DCC Office Compound in Athi River", landmark: "N/A", distance: "N/A" },
  ...
  // KISUMU COUNTY
  { county: "Kisumu", constituency: "Nyando", location: "Awasi DCC Compound", landmark: "N/A", distance: "N/A" },
  { county: "Kisumu", constituency: "Muhoroni", location: "Awasi", landmark: "Pawtenge Primary", distance: "N/A" },
  { county: "Kisumu", constituency: "Nyakach", location: "Pap Onditi DCC Compound", landmark: "N/A", distance: "N/A" },
  { county: "Kisumu", constituency: "Seme", location: "Kombewa DCC Compound", landmark: "N/A", distance: "N/A" },
  { county: "Kisumu", constituency: "Kisumu West", location: "DCCs office block", landmark: "Huduma centre and CDF office", distance: "N/A" },
  { county: "Kisumu", constituency: "Kisumu East", location: "Mamboleo Show Ground", landmark: "N/A", distance: "N/A" },
  { county: "Kisumu", constituency: "Kisumu Central", location: "Huduma Centre Wing C Ground Floor", landmark: "N/A", distance: "N/A" },
  // HOMABAY COUNTY
  { county: "Homabay", constituency: "Kasipul", location: "Karachuonyo South DCC Compound at Kosele", landmark: "N/A", distance: "N/A" },
  { county: "Homabay", constituency: "Kabondo Kasipul", location: "At Kadongo Centre", landmark: "Kisii - Kisumu Road", distance: "N/A" },
  { county: "Homabay", constituency: "Karachuonyo", location: "Rachuonyo North DCC Complex at Kamodi", landmark: "N/A", distance: "N/A" },
  { county: "Homabay", constituency: "Rangwe", location: "New Rangwe DCC's Complex", landmark: "N/A", distance: "N/A" },
  { county: "Homabay", constituency: "Homa Bay Town", location: "Behind CC's Complex", landmark: "N/A", distance: "N/A" },
  { county: "Homabay", constituency: "Ndhiwa", location: "Ndhiwa Sub County DCC Complex", landmark: "N/A", distance: "N/A" },
  ...
  { county: "Homabay", constituency: "Suba South", location: "At Magunga Trading Centre", landmark: "N/A", distance: "N/A" },
  // MIGORI COUNTY
